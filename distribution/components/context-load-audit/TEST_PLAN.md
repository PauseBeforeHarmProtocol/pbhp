# Test Plan — Context Load Audit

**Project:** pbhp  
**Component:** `context-load-audit`  
...
- [ ] Produces or preserves: Disclosure
- [ ] Produces or preserves: Refresh or recovery action
- [ ] Produces or preserves: Proceed condition
- [ ] Produces or preserves: Override record

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Self-report presented as measurement
- [ ] Detects or blocks: High-stakes work under unknown load
- [ ] Detects or blocks: Silent compaction
- [ ] Detects or blocks: Override without record
