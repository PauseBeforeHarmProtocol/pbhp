# Test Plan — Anchors Ledger

**Project:** pbhp  
**Component:** `anchors-ledger`  
...
- [ ] Produces or preserves: Anchor set
- [ ] Produces or preserves: Change record
- [ ] Produces or preserves: Drift finding

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Silent edit
- [ ] Detects or blocks: Anchor replacement by convenience
- [ ] Detects or blocks: Too many anchors
- [ ] Detects or blocks: Unversioned changes
