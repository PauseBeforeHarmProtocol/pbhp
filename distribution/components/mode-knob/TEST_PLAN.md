...
- [ ] Produces or preserves: EXPLORE
- [ ] Produces or preserves: COMPRESS
- [ ] Produces or preserves: BOTH
- [ ] Produces or preserves: Mode-bound output

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Compression before inspection
- [ ] Detects or blocks: Exploration without closure
- [ ] Detects or blocks: Mode used to bypass a refusal
- [ ] Detects or blocks: Unstated mode switch
