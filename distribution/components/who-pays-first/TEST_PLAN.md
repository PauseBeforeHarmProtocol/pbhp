# Test Plan — Who Pays First

**Project:** pbhp  
**Component:** `who-pays-first`  
...
- [ ] Produces or preserves: First-cost stakeholder
- [ ] Produces or preserves: First harm
- [ ] Produces or preserves: Recovery path
- [ ] Produces or preserves: Evidence basis

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Centering the decision-maker
- [ ] Detects or blocks: Using abstract stakeholders
- [ ] Detects or blocks: Ignoring delayed or distributed harm
- [ ] Detects or blocks: Assuming recovery without a mechanism
