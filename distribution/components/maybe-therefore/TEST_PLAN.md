# Test Plan — Maybe / Therefore

**Project:** pbhp  
**Component:** `maybe-therefore`  
...
- [ ] Produces or preserves: Substantive Maybe
- [ ] Produces or preserves: Evidence-bound Therefore
- [ ] Produces or preserves: Decision state

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Ceremonial objection
- [ ] Detects or blocks: Straw man
- [ ] Detects or blocks: Rhetorical flourish
- [ ] Detects or blocks: Therefore that ignores the Maybe
