# Test Plan — Corrective and Preventive Action
...
- [ ] Produces or preserves: Correction
- [ ] Produces or preserves: Preventive control
- [ ] Produces or preserves: Effectiveness criterion
- [ ] Produces or preserves: Closure record

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Closing on implementation alone
- [ ] Detects or blocks: Blame substitution
- [ ] Detects or blocks: No effectiveness check
- [ ] Detects or blocks: Repeated recurrence without escalation
