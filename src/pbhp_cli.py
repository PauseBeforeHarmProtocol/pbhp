...
An interactive command-line interface for conducting PBHP v0.8.1 assessments,
...
""")
    ...
    if not confirmed:
        ...
        print("  Please review the PBHP v0.8.1 specification before proceeding.")
...
def full_assessment(engine):
    """Run the complete PBHP v0.8.1 assessment walkthrough."""
    banner("PBHP v0.8.1 Full Assessment Walkthrough", char="=")
    print("""
...
def show_help():
  ...
  1. Start New Assessment
     Complete guided walkthrough of all PBHP v0.8.1 protocol steps,
