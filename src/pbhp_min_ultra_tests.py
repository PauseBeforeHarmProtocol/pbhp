...
def test_min_serialization():
    ...
    assert_eq("MIN dict version", d["version"], "0.8.0-MIN")
    ...
    j = log.to_json()
    parsed = json.loads(j)
    assert_eq("MIN JSON version", parsed["version"], "0.8.0-MIN")
...
def test_ultra_create_assessment():
    ...
    assert_eq("ultra version", ulog.version, "0.8.0-ULTRA")
...
def test_ultra_serialization():
    ...
    assert_eq("ultra dict version", d["version"], "0.8.0-ULTRA")
