# Test Plan — Causal Field Check

**Project:** shadow  
**Component:** `causal-field-check`  
**Library version:** 1.0.0  
**Release date:** 2026-07-18

## Current evidence statement

Primitive is specified; causal accuracy and intervention value remain open.

## Test levels

### 1. Contract fidelity

- [ ] Produces or preserves: Causal-field map
- [ ] Produces or preserves: Contributing factors
- [ ] Produces or preserves: Scoped intervention

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Blame compression
- [ ] Detects or blocks: Single-cause certainty
- [ ] Detects or blocks: Uncertainty paralysis
- [ ] Detects or blocks: Context used to erase responsibility
...
- [ ] Counterfactual causal cases
- [ ] Expert review
- [ ] Compare actor-only and field-aware interventions
