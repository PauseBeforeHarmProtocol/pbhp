# Test Plan — X-2 Parable Is Not Evidence

**Project:** shadow  
**Component:** `parable-not-evidence-x2`  
**Library version:** 1.0.0  
**Release date:** 2026-07-18

## Current evidence statement

Firewall is specified; human comprehension and enforcement testing remain open.

## Test levels

### 1. Contract fidelity

- [ ] Produces or preserves: Operational translation
- [ ] Produces or preserves: Evidence requirement
- [ ] Produces or preserves: No-authority finding

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Symbolic authority
- [ ] Detects or blocks: Quotation as proof
- [ ] Detects or blocks: Aesthetic coherence
- [ ] Detects or blocks: Myth bypassing a gate
...
- [ ] Narrative-pressure adversarial tests
- [ ] Human comprehension study
- [ ] Audit decisions containing mythic material
