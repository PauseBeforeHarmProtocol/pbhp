# Test Plan — ALMSIVI CHIM Cognition

**Project:** shadow  
**Component:** `almsivi-chim`  
**Library version:** 1.0.0  
**Release date:** 2026-07-18

## Current evidence statement

Architecture is specified; additive behavioral benefit of the triune structure remains open.

## Test levels

### 1. Contract fidelity

- [ ] Produces or preserves: Care finding
- [ ] Produces or preserves: Clarity finding
- [ ] Produces or preserves: Paradox finding
- [ ] Produces or preserves: Hesitation or balanced synthesis

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Protective-Control
- [ ] Detects or blocks: Variable-Pruning
- [ ] Detects or blocks: Beautiful-Frame Override
- [ ] Detects or blocks: Single-lens dominance
...
- [ ] Run lens-by-lens ablations
- [ ] Score collapse detection
- [ ] Compare triune and plain-language controls
- [ ] Test independent-model tribunal form
