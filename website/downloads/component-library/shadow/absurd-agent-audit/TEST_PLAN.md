# Test Plan — Absurd-Agent Audit

**Project:** shadow  
**Component:** `absurd-agent-audit`  
...
- [ ] Produces or preserves: Purpose remains valid
- [ ] Produces or preserves: Purpose revised
- [ ] Produces or preserves: Pause or shutdown

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Goal persistence
- [ ] Detects or blocks: Sunk-cost purpose
- [ ] Detects or blocks: Identity-bound objective
- [ ] Detects or blocks: No beneficiary
