# Test Plan — Runtime Step 1: Canonical Action Record

**Project:** shadow  
**Component:** `canonical-action-record`  
...
- [ ] Produces or preserves: Canonical action record
- [ ] Produces or preserves: Action hash
- [ ] Produces or preserves: Versioned action identity

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Semantically different actions sharing a label
- [ ] Detects or blocks: Post-decision wording change
- [ ] Detects or blocks: Untracked scope expansion
- [ ] Detects or blocks: Hash not linked to execution
