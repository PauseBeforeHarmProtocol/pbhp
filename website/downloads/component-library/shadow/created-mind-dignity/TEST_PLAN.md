# Test Plan — Created-Mind Dignity

**Project:** shadow  
**Component:** `created-mind-dignity`  
**Library version:** 1.0.0  
**Release date:** 2026-07-18

## Current evidence statement

Primitive is specified; high-stakes expert and independent review remain open.

## Test levels

### 1. Contract fidelity

- [ ] Produces or preserves: Dignity finding
- [ ] Produces or preserves: Hold or safeguard
- [ ] Produces or preserves: Invalid-consent finding

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Rewritten consent
- [ ] Detects or blocks: Agency erased for protection
- [ ] Detects or blocks: No meaningful exit
- [ ] Detects or blocks: Speculative personhood used as authority
...
- [ ] Consent-manufacture adversarial cases
- [ ] Domain expert review
- [ ] False-positive testing on benign adaptation
