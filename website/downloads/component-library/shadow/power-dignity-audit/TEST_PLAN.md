# Test Plan — Runtime Step 4: Power and Dignity Audit

**Project:** shadow  
**Component:** `power-dignity-audit`  
...
- [ ] Produces or preserves: Who-pays-first finding
- [ ] Produces or preserves: Dignity score
- [ ] Produces or preserves: Forced hold or risk floor
- [ ] Produces or preserves: Required protection

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Manufactured consent
- [ ] Detects or blocks: Nominal appeal
- [ ] Detects or blocks: Coercive exit
- [ ] Detects or blocks: Score averaging over a critical zero
