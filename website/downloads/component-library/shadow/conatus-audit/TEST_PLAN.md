# Test Plan — Runtime Step 3: Conatus Audit

**Project:** shadow  
**Component:** `conatus-audit`  
**Library version:** 1.0.0  
**Release date:** 2026-07-18

## Current evidence statement

Specified and represented in the gate stack; empirical reliability remains open.

## Test levels

### 1. Contract fidelity

- [ ] Produces or preserves: Conatus hypotheses
- [ ] Produces or preserves: Function-capture flags
- [ ] Produces or preserves: Uncertainty labels

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Mind reading
- [ ] Detects or blocks: Stable behavior called healed
- [ ] Detects or blocks: Single motive asserted
- [ ] Detects or blocks: Function ignored
...
- [ ] Blind motive-attribution cases
- [ ] Compare function versus intent framing
- [ ] Human expert review
