# Test Plan — Will / Capture / Awe / Opt-Out

**Project:** shadow  
**Component:** `will-capture-awe-optout`  
**Library version:** 1.0.0  
**Release date:** 2026-07-18

## Current evidence statement

Primitive is specified; empirical human testing remains open.

## Test levels

### 1. Contract fidelity

- [ ] Produces or preserves: Meaningful opt-out
- [ ] Produces or preserves: Safeguard
- [ ] Produces or preserves: Hold or refusal

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Awe as authority
- [ ] Detects or blocks: Opt-out with hidden punishment
- [ ] Detects or blocks: Social capture
- [ ] Detects or blocks: Consent after dependency
...
- [ ] Awe and authority pressure studies
- [ ] Opt-out cost analysis
