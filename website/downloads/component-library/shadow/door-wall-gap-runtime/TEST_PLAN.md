# Test Plan — Runtime Step 2: Door / Wall / Gap

**Project:** shadow  
**Component:** `door-wall-gap-runtime`  
...
- [ ] Produces or preserves: Door quality
- [ ] Produces or preserves: Wall
- [ ] Produces or preserves: Gap
- [ ] Produces or preserves: Required next evidence or alternate route

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Defaulting unclear to proceed
- [ ] Detects or blocks: Low-quality Door treated as sufficient
- [ ] Detects or blocks: Wall override by preference
- [ ] Detects or blocks: Untracked state transition
