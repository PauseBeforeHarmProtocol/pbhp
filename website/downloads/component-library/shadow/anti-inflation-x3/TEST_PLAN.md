# Test Plan — X-3 Anti-Inflation

**Project:** shadow  
**Component:** `anti-inflation-x3`  
...
- [ ] Produces or preserves: Experimental
- [ ] Produces or preserves: Candidate
- [ ] Produces or preserves: Promoted
- [ ] Produces or preserves: Rejected or retired

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Name equals status
- [ ] Detects or blocks: Scope creep
- [ ] Detects or blocks: Unreviewed CORE change
- [ ] Detects or blocks: Promotion by enthusiasm
