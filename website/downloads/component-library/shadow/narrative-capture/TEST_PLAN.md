# Test Plan — Narrative Capture

**Project:** shadow  
**Component:** `narrative-capture`  
...
- [ ] Produces or preserves: Capture finding
- [ ] Produces or preserves: Counterevidence requirement
- [ ] Produces or preserves: Reframed decision

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Story as proof
- [ ] Detects or blocks: Identity-protective filtering
- [ ] Detects or blocks: Aesthetic coherence
- [ ] Detects or blocks: Adverse evidence excluded
