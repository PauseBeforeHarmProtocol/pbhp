# Test Plan — Provenance Machinery

**Project:** shadow  
**Component:** `provenance-machinery`  
...
- [ ] Produces or preserves: Provenance grade
- [ ] Produces or preserves: Binding or non-binding status
- [ ] Produces or preserves: Downgrade record
- [ ] Produces or preserves: Refusal if unsupported

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Name treated as evidence
- [ ] Detects or blocks: Declaration changes decision
- [ ] Detects or blocks: Unresolvable hash
- [ ] Detects or blocks: Confidence without source
