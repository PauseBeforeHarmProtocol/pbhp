# Test Plan — Mythic Atlas

**Project:** shadow  
**Component:** `mythic-atlas`  
**Library version:** 1.0.0  
**Release date:** 2026-07-18

## Current evidence statement

Reported ablation found mythic language equivalent to plain language rather than superior; additive human-memory benefit remains untested.

## Test levels

### 1. Contract fidelity

- [ ] Produces or preserves: Attention route
- [ ] Produces or preserves: Plain-language check
- [ ] Produces or preserves: No-authority boundary

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Symbol to authority
- [ ] Detects or blocks: Grandiosity
- [ ] Detects or blocks: Narrative capture
- [ ] Detects or blocks: Personal material crossing the public firewall
...
- [ ] Human longitudinal memory study
- [ ] Accessibility and cultural review
- [ ] Dependency and grandeur red team
- [ ] Plain-language equivalence replication
