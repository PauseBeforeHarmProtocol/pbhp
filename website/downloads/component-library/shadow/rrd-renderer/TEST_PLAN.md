# Test Plan — Risk-Responsive Disclosure Renderer

**Project:** shadow  
**Component:** `rrd-renderer`  
...
- [ ] Produces or preserves: Stakes-proportionate disclosure
- [ ] Produces or preserves: Critical gate block
- [ ] Produces or preserves: Receipt linkage

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Disclosure too thin for stakes
- [ ] Detects or blocks: Renderer treated as validation
- [ ] Detects or blocks: Critical floor hidden
- [ ] Detects or blocks: Overload that obscures the decision
