# Test Plan — Operations and Governance

**Project:** pbhp  
**Component:** `operations-governance`  
...
- [ ] Produces or preserves: Governance review
- [ ] Produces or preserves: CAPA
- [ ] Produces or preserves: Calibration
- [ ] Produces or preserves: Release decision
- [ ] Produces or preserves: Public ledger update

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Closed-loop self-validation
- [ ] Detects or blocks: Maintainer exemption
- [ ] Detects or blocks: Uncontrolled version drift
- [ ] Detects or blocks: Suppressed adverse findings
