...
- [ ] Produces or preserves: Evidence state
- [ ] Produces or preserves: Scoped public claim
- [ ] Produces or preserves: Open validation work
- [ ] Produces or preserves: Prohibited overclaim

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Global green
- [ ] Detects or blocks: Version mixing
- [ ] Detects or blocks: Hiding adverse results
- [ ] Detects or blocks: Treating names or mappings as evidence
