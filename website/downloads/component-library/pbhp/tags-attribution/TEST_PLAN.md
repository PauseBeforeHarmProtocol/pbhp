# Test Plan — Tags and Attribution

**Project:** pbhp  
**Component:** `tags-attribution`  
...
- [ ] Produces or preserves: Evidence tag
- [ ] Produces or preserves: Attribution grade
- [ ] Produces or preserves: Required verification

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Tagging without evidence
- [ ] Detects or blocks: Inferred material stated as fact
- [ ] Detects or blocks: Source laundering
- [ ] Detects or blocks: Grade inflation
