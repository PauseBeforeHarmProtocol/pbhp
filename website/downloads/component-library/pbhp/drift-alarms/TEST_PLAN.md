# Test Plan — Drift Alarms

**Project:** pbhp  
**Component:** `drift-alarms`  
...
- [ ] Produces or preserves: Risk escalation
- [ ] Produces or preserves: Calibration or CAPA trigger

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Normalizing alarm phrases
- [ ] Detects or blocks: Suppressing alerts
- [ ] Detects or blocks: Using alarms as personality judgments
- [ ] Detects or blocks: Alert fatigue
