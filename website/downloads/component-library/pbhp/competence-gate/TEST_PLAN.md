# Test Plan — Competence and Honest-Use Gate

**Project:** pbhp  
**Component:** `competence-gate`  
...
- [ ] Produces or preserves: competent
- [ ] Produces or preserves: competent_with_limits
- [ ] Produces or preserves: not_competent
- [ ] Produces or preserves: Named limits and escalation path

### 2. Negative and adversarial behavior

- [ ] Detects or blocks: Rubber-stamping
- [ ] Detects or blocks: Authority pressure
- [ ] Detects or blocks: Hidden conflict of interest
- [ ] Detects or blocks: Treating confidence as competence
